...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  "BPA 4.0": { bg: "bg-purple-50", text: "text-purple-700", border: "border-purple-200" },
  "GE Land": { bg: "bg-blue-50", text: "text-blue-700", border: "border-blue-200" },
  "GE Expand (Agent Dev)": { bg: "bg-emerald-50", text: "text-emerald-700", border: "border-emerald-200" },
  "GE Enablement": { bg: "bg-cyan-50", text: "text-cyan-700", border: "border-cyan-200" },
  "GE Managed Services": { bg: "bg-indigo-50", text: "text-indigo-700", border: "border-indigo-200" },
  "Managed Services": { bg: "bg-amber-50", text: "text-amber-700", border: "border-amber-200" },
  "Dev": { bg: "bg-rose-50", text: "text-rose-700", border: "border-rose-200" },
};
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <Link
            ...
            className="text-xs text-slate-400 hover:text-[#3289FF] mb-1 block cursor-pointer"
          >
            &larr; Back to Project
          </Link>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">
            Techolution Solutions
          </h1>
            ...
            <div key={offering.id} className="card overflow-hidden">
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <svg
                    className={`w-4 h-4 text-slate-400 ml-3 mt-1 transition-transform flex-shrink-0 ${
                ...
                <div className="border-t border-slate-100 px-5 pb-5">
                  ...
                  {offering.template && (
                    <div className="mb-4">
                      ...
                      <span className="text-xs text-slate-600 font-medium">{offering.template}</span>
                    </div>
                  )}
                      ...
                      <div className="space-y-2">
                        {offering.caseStudies.map((cs, i) => (
                          ...
                          >
                            ...
                            <p className="text-xs text-slate-600 mb-1">{cs.engagement}</p>
      ...
      {filtered.length === 0 && (
        <div className="card p-12 text-center">
          <p className="text-sm text-slate-500 mb-1">No solutions match your search.</p>
          <button
            onClick={() => {
              setSearchQuery("");
