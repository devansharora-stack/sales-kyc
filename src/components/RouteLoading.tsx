  ...
  return (
    <div className="animate-fade-in space-y-4">
      ...
      <div className="card p-6 space-y-3">
        <div className="h-7 w-64 bg-slate-100 rounded animate-pulse" />
        <div className="h-4 w-80 bg-slate-50 rounded animate-pulse" />
      ...
      <div className="card p-6 space-y-3">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="h-4 bg-slate-50 rounded animate-pulse" style={{ width: `${90 - i * 14}%` }} />
        ))}
      </div>
    </div>
  );
