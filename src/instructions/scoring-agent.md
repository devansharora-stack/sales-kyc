...
## Sources
- Set `sources` to an empty array `[]` for every dimension — sources are injected programmatically from upstream research data after your response
- Do NOT generate or fabricate any URLs
